...
val parksByDong: Map<String, List<Park>> = mapOf(
    "정왕1동" to listOf(
        ...
        Park("젊음과패기공원", LatLng(37.348403, 126.74004), R.drawable.intersect, address = "정왕동 1800-5", description = "물 놀이터, 개방화장실, 정자, 산책로, 벤치"),
        Park("평안공원", LatLng(37.339471, 126.741545), R.drawable.intersect, address = "정왕동 1787-4", description = "정자, 산책로, 미니 폭포, 정자")
    ),

    "정왕2동" to listOf(
        Park("희망공원", LatLng(37.337075, 126.714717), R.drawable.intersect, address = "정왕동 1358", description = "풋살장, 테니스 코트, 화장실, 산책로, 벤치"),
        Park("서촌공원", LatLng(37.348583, 126.726767), R.drawable.intersect, address = "정왕동 1848-2", description = "산책로, 흙운동장, 정자, 벤치"),
        Park("중앙공원", LatLng(37.349188, 126.735365), R.drawable.intersect, address = "정왕동 1845-1", description = "중앙 무대, 산책로, 자전거 도로, 벤치"),
        Park("사랑공원", LatLng(37.355439, 126.733894), R.drawable.intersect, address = "정왕동 1872-7", description = "놀이터, 정자, 벤치"),
        Park("시화2공원", LatLng(37.357594, 126.733953), R.drawable.intersect, address = "정왕동 1872-1", description = "농구 골대, 벤치"),
        Park("송운공원", LatLng(37.358441, 126.732652), R.drawable.intersect, address = "정왕동 1873-1", description = "작은 도서관, 테니스 코트, 정자, 산책로, 벤치")
    ),

    "정왕3동" to listOf(
        Park("오이도공원", LatLng(37.341666, 126.689871), R.drawable.intersect, address = "정왕동 2040-1", description = "주차장, 산책로, 정자, 벤치"),
        Park("옥터공원", LatLng(37.346452, 126.689584), R.drawable.intersect, address = "정왕동 1998-5", description = "운동기구, 놀이터, 정자, 벤치"),
